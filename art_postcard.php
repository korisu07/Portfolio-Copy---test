...
<meta name="description" content="ポートフォリオ「絵はがき集」の紹介ページです。">
<meta name="keywords" content="Portfolio,ポートフォリオ,Web制作,自主制作,個人制作">

<title>Art 絵はがき - Y.K.Portfolio</title>
        ...
        <div class="postcard-wrapper">
          ...
          <div class="postcard-box">
            <a href="img/postcard/perfume.jpg" class="open_img">
              ...
              <div class="card-text">
                <h3>一歩、踏み出す勇気を</h3>
                <p>女の子の一歩を後押しできそうな香水をイメージしました。</p>
              </div>
            </a>
          </div> <!-- /.postcard-box -->
          ...
          <div class="postcard-box">
            <a href="img/postcard/cloud.jpg" class="open_img">
              ...
              <div class="card-text">
                <h3>入道雲</h3>
                <p>制作時期が夏頃でしたので、<br>夏らしいテーマにしてみました。</p>
              </div>
            </a>
          </div> <!-- /.postcard-box -->
          ...
          <div class="postcard-box">
            <a href="img/postcard/tyou.jpg" class="open_img">
              ...
              <div class="card-text">
                <h3>蝶々</h3>
                <p>サインペンだけで細かいところを表現できるように工夫しました。</p>
              </div>
            </a>
          </div> <!-- /.postcard-box -->
          ...
          <div class="postcard-box">
            <a href="img/postcard/butineko.jpg" class="open_img">
              ...
              <div class="card-text">
                <h3>ぶちねこちゃん</h3>
                <p>絵葉書として使いやすいタイプのデザインを意識しました。</p>
              </div>
            </a>
          </div> <!-- /.postcard-box -->
